namespace CUERipper
{
	partial class frmCUERipper
	{
		...
		private void InitializeComponent()
		{
			...
			this.Lyricist = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// TrackNo
			// 
			this.TrackNo.DataPropertyName = "Number";
			...
			// Lyricist
			// 
			this.Lyricist.DataPropertyName = "Lyricist";
			this.Lyricist.Name = "Lyricist";
			// 
			// Comment
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn Lyricist;
